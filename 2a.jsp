    ...
    <table border="1">
        <tr>
            ...
            <%
                    ...
                    %>
                    <tr><th>the Classes he cannot take for this quarter (Including classes he currently taking)</th></tr>
                    <tr>
                        <th>Title</th>
                        <th>CourseNumber</th>
                    </tr>
                    ...
                    <tr>
                        <form action="2a.jsp" method="get">
                            ...
                            <td>
                                <input value="<%= rs3.getString("Title") %>"
                                    name="Title" size="30">
                            </td>
                            ...
                            <%-- Get the FIRSTNAME --%>
                            <td>
                                <input value="<%= rs3.getString("CourseNumber") %>"
                                    name="CourseNumber" size="20">
                            </td>
                         </form>
                      </tr>
